    ...
    <div class="container">
      <div class="columns is-desktop">
        ...
        <div class="column">
          ...
          <h3 class="subtitle has-text-centered">{{ USER_INFO.title }}</h3>
