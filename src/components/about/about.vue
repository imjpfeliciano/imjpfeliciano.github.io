...
<div class="flex bg-white" style="height: 600px;">
        <div class="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
            <div>
                <h2 class="text-3xl font-semibold text-gray-800 md:text-4xl">I'm <span class="text-indigo-600">Software Engineer</span></h2>
        ...
        <div class="hidden lg:block lg:w-1/2" style="clip-path:polygon(10% 0, 100% 0%, 100% 100%, 0 100%)">
            <div class="bg-no-repeat h-screen object-fill"
...
import ProfileImage from '../../assets/images/coding-time.jpg';
